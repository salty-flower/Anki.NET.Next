...
public class AnkiFileReaderTests
{
    ...
    public async Task WhenRead_ThenNoExceptionIsThrown()
    {
        ...
        collection.Decks.Should().BeEquivalentTo(expectedDecks, o => o.Excluding(d => d.Cards));
...
{{Back}}"
        ...
        collection.NoteTypes.Should().BeEquivalentTo(expectedNoteTypes);
        ...
        var expectedJapaneseDeckCards = new[]
        {
            new AnkiCard(
                1661780059803L,
                new AnkiNote(1661780059797L, noteTypeId, "人【ひと】", "person; someone; somebody"),
                0
            ),
            new AnkiCard(
                1661780059806L,
                new AnkiNote(1661780059804L, noteTypeId, "男【おとこ】", "man; male"),
                0
            ),
            new AnkiCard(
                1661780059808L,
            ...
            new AnkiCard(
                1661780059813L,
                new AnkiNote(1661780059811L, noteTypeId, "日【ひ】", "day; days"),
                0
            ),
            new AnkiCard(
                1661780059815L,
                new AnkiNote(1661780059814L, noteTypeId, "月【つき】", "Moon"),
                0
            ),
            new AnkiCard(
                1661780059817L,
                new AnkiNote(1661780059816L, noteTypeId, "時【とき】", "time; hour; moment"),
                0
            ),
            new AnkiCard(
                1661780059820L,
            ...
            new AnkiCard(
                1661780059822L,
                new AnkiNote(1661780059821L, noteTypeId, "火【ひ】", "fire; flame; blaze"),
                0
            ),
            new AnkiCard(
                1661780059824L,
            ...
            new AnkiCard(
                1661780059827L,
                new AnkiNote(1661780059826L, noteTypeId, "空【そら】", "sky; the air; the heavens"),
                0
            ),
            new AnkiCard(
                1661780059829L,
                new AnkiNote(1661780059828L, noteTypeId, "山【やま】", "mountain; hill"),
                0
            ),
            new AnkiCard(
                1661780059831L,
                new AnkiNote(1661780059830L, noteTypeId, "川【かわ】", "river; stream"),
                0
            ),
            new AnkiCard(
                1661780059834L,
                new AnkiNote(1661780059832L, noteTypeId, "木【き】", "tree; shrub; bush"),
                0
            ),
            new AnkiCard(
                1661780059836L,
            ...
            new AnkiCard(
                1661780059838L,
                new AnkiNote(1661780059837L, noteTypeId, "雨【あめ】", "rain"),
                0
            ),
            new AnkiCard(
                1661780059840L,
                new AnkiNote(1661780059839L, noteTypeId, "雪【ゆき】", "snow; snowfall"),
                0
            ),
            new AnkiCard(
                1661780059841L,
                new AnkiNote(1661780059840L, noteTypeId, "金【かね】", "money"),
                0
            ),
            new AnkiCard(
                1661780059843L,
        ...
        collection.Decks[1].Cards.Should().BeEquivalentTo(expectedJapaneseDeckCards);
    }
    ...
    {
        var action = async () =>
            _ = await AnkiFileReader.ReadFromFileAsync("db_files/collection21b.apkg");
